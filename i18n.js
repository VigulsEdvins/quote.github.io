...
window.QuoteI18n = {
  English: {
    ...
    gen_view_saved_quotes: "Saved Quotes",
    ...
    // Item & Price Catalog
    btn_item_catalog: "📦 Item Catalog",
    btn_from_catalog: "📦 From Catalog",
    catalog_title: "Item & Price Catalog",
    catalog_subtitle: "1-click insert reusable materials and labor rates",
    catalog_search_placeholder: "Search catalog items or rates...",
    catalog_tab_all: "All",
    catalog_tab_materials: "🧱 Materials",
    catalog_tab_labour: "⚡ Labour & Services",
    catalog_btn_toggle_add: "Create New Custom Item",
    catalog_label_name: "Item Name",
    catalog_label_type: "Type",
    catalog_type_material: "🧱 Material",
    catalog_type_labour: "⚡ Labour",
    catalog_label_sub: "Specs / Details",
    catalog_label_qty: "Default Qty/Duration",
    catalog_label_price: "Default Price",
    catalog_btn_save_item: "💾 Save to Library",
    catalog_btn_add: "+ Add to Quote",
    catalog_btn_add_to_quote: "+ Add to Quote",
    catalog_btn_added: "✓ Added",
    catalog_added_feedback: "✓ Added",
    catalog_empty_title: "No items found",
    catalog_empty_desc: "Try a different search term or add a new item above.",
    toast_item_added_to_quote: "📦 Added to quote!",
    toast_catalog_item_saved: "💾 Item saved to catalog library!",
    toast_catalog_item_deleted: "🗑️ Item removed from catalog.",
  ...
  Latvian: {
    ...
    gen_view_saved_quotes: "Saglabātās tāmes",
    ...
    // Item & Price Catalog
    btn_item_catalog: "📦 Pozīciju katalogs",
    btn_from_catalog: "📦 No kataloga",
    catalog_title: "Materiālu un pakalpojumu katalogs",
    catalog_subtitle: "1 klikšķa pievienošana biežāk lietotajiem materiāliem un likmēm",
    catalog_search_placeholder: "Meklēt pozīcijas vai likmes...",
    catalog_tab_all: "Visi",
    catalog_tab_materials: "🧱 Materiāli",
    catalog_tab_labour: "⚡ Meistara darbs",
    catalog_btn_toggle_add: "Pievienot jaunu pozīciju",
    catalog_label_name: "Pozīcijas nosaukums",
    catalog_label_type: "Veids",
    catalog_type_material: "🧱 Materiāls",
    catalog_type_labour: "⚡ Darbs",
    catalog_label_sub: "Specifikācija / Apraksts",
    catalog_label_qty: "Noklusējuma daudzums",
    catalog_label_price: "Noklusējuma cena",
    catalog_btn_save_item: "💾 Saglabāt katalogā",
    catalog_btn_add: "+ Pievienot tāmei",
    catalog_btn_add_to_quote: "+ Pievienot tāmei",
    catalog_btn_added: "✓ Pievienots",
    catalog_added_feedback: "✓ Pievienots",
    catalog_empty_title: "Nav atrasta neviena pozīcija",
    catalog_empty_desc: "Mēģiniet meklēt citādi vai pievienojiet jaunu pozīciju augstāk.",
    toast_item_added_to_quote: "📦 Pievienots tāmei!",
    toast_catalog_item_saved: "💾 Pozīcija saglabāta katalogā!",
    toast_catalog_item_deleted: "🗑️ Pozīcija dzēsta no kataloga.",
  ...
  German: {
    ...
    gen_view_saved_quotes: "Gespeicherte Angebote",
    ...
    // Item & Price Catalog
    btn_item_catalog: "📦 Positionskatalog",
    btn_from_catalog: "📦 Aus Katalog",
    catalog_title: "Material- & Leistungskatalog",
    catalog_subtitle: "1-Klick-Einfügen wiederkehrender Materialien und Stundensätze",
    catalog_search_placeholder: "Katalogpositionen oder Sätze suchen...",
    catalog_tab_all: "Alle",
    catalog_tab_materials: "🧱 Materialien",
    catalog_tab_labour: "⚡ Handwerkerleistungen",
    catalog_btn_toggle_add: "Neuen Eintrag erstellen",
    catalog_label_name: "Positionsname",
    catalog_label_type: "Typ",
    catalog_type_material: "🧱 Material",
    catalog_type_labour: "⚡ Arbeitsleistung",
    catalog_label_sub: "Spezifikation / Details",
    catalog_label_qty: "Standardmenge / Dauer",
    catalog_label_price: "Standardpreis",
    catalog_btn_save_item: "💾 Im Katalog speichern",
    catalog_btn_add: "+ Zum Angebot hinzufügen",
    catalog_btn_add_to_quote: "+ Zum Angebot hinzufügen",
    catalog_btn_added: "✓ Hinzugefügt",
    catalog_added_feedback: "✓ Hinzugefügt",
    catalog_empty_title: "Keine Einträge gefunden",
    catalog_empty_desc: "Versuchen Sie einen anderen Suchbegriff oder erstellen Sie einen neuen Eintrag.",
    toast_item_added_to_quote: "📦 Zum Angebot hinzugefügt!",
    toast_catalog_item_saved: "💾 Eintrag im Katalog gespeichert!",
    toast_catalog_item_deleted: "🗑️ Eintrag aus Katalog gelöscht.",
